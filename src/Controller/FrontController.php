...
class FrontController extends AbstractController
{
    ...
    public function ajoutercommentaire(ActualiteRepository $repository, $id, Request $request, EntityManagerInterface $em,UserRepository $userRepository,BadWordsFilterService $badWordFilter): Response
    {$user=new User();
